        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="mt-2 text-xs">
              <span className="text-neutral-400">Official Page: </span>
              <a
                href="https://facebook.com/iosemojis"
                target="_blank"
                rel="noopener"
                className="text-blue-600 dark:text-blue-400 hover:underline font-semibold inline-flex items-center gap-1.5"
              >
